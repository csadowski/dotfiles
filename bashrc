...
function vim-writer { vim -c 'set tw=72 et' '+/^$' --cmd 'set spell spelllang=en_gb' -c 'set formatoptions+=aw' -c 'set ai' "$@" ;}
function gvim-writer { gvim -c 'set tw=72 et' '+/^$' --cmd 'set spell spelllang=en_gb' -c 'set formatoptions+=aw' -c 'set ai' "$@" ;}
